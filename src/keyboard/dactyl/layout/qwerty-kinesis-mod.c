...
// left hand
   ...
   _shiftL,         _Z,        _X,          _C,           _D,    _V,
    _ctrlL,         _2, _bracketL,   _bracketR,   _backslash,
                                                        _del,  _del,
                                                              _guiL,
                                                   _bs,   1,  _altR,
// right hand
...
// left hand
 ...
 kprrel, sshprre, kprrel,  kprrel, kprrel,
                                                 kprrel, kprrel,
                                                         kprrel,
...
// right hand
                ...
                sshprre,  kprrel,  kprrel,  ktrans,  ktrans,  ktrans,
                          ktrans,  ktrans,  ktrans,  ktrans,  ktrans,
 ktrans, ktrans,
 ktrans,
 ktrans, ktrans, ktrans ),
...
// right hand
               ...
               sshprre, kprrel,  kprrel,  ktrans,  ktrans,  kprrel,
                        ktrans,  ktrans,  ktrans,  ktrans,  ktrans,
 ktrans, ktrans,
 ktrans,
 ktrans, ktrans, ktrans ),
